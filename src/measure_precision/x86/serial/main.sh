...
function tdiff_test() {
    ...
    do
        ...
        do
            ...
            python algo.py -s 1,1 -e 1,2 -i ${output_dir} -b ${tool} -f variation_resolution -a ${k},${tmin_delay},${tcost_file},${tdiff_file}
...
function main() {
    ...
    do
        ...
        tmin_file="${result_dir}/${tool}_tmin_check_${tmin_check_num}.txt"
        ...
        cy_tdiff_file="${result_dir}/${tool}_cycle_resolution_${tdiff_test_num}.txt"
        ns_tdiff_file="${result_dir}/${tool}_nanosec_resolution_${tdiff_test_num}.txt"
